...
export const Route = createFileRoute("/menu")({
  head: () => ({
    meta: [
      { title: "Full Menu — Urban Zaiqa Restaurant & Catering" },
      {
        name: "description",
        content:
          "Explore the complete Urban Zaiqa menu: biryani, karahi, nihari, BBQ, fast food, snacks and desserts with live pricing.",
      },
      { property: "og:title", content: "Full Menu — Urban Zaiqa" },
      { property: "og:description", content: "Biryani, karahi, BBQ, snacks & desserts with prices." },
    ],
  }),
  component: MenuPage,
});
