...
export const Route = createFileRoute("/packages")({
  head: () => ({
    meta: [
      { title: "Catering Packages — Urban Zaiqa | Karachi" },
      {
        name: "description",
        content:
          "Browse 9 premium Pakistani catering packages from Rs 600 to Rs 1200 per head. Biryani, karahi, tikka, kababs, desserts. Order instantly on WhatsApp.",
      },
      { property: "og:title", content: "Catering Packages — Urban Zaiqa" },
      {
        property: "og:description",
        content: "9 packages, every budget, full menu, instant WhatsApp ordering.",
      },
    ],
  }),
