...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "Gallery — Urban Zaiqa Restaurant & Catering" },
      {
        name: "description",
        content:
          "Browse Urban Zaiqa's gallery: biryani, BBQ, karahi and desserts from our finest events and signature dishes.",
      },
      { property: "og:title", content: "Gallery — Urban Zaiqa" },
      { property: "og:description", content: "A glimpse of our finest dishes and dawats." },
      { property: "og:image", content: spread },
    ],
  }),
