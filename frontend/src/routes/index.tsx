...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Urban Zaiqa — Authentic Pakistani Restaurant & Catering, Karachi" },
      {
        name: "description",
        content:
          "Urban Zaiqa Restaurant & Catering brings the authentic taste of Pakistan to weddings, dawats and corporate events. Premium catering packages from Rs 600/head.",
      },
      { property: "og:title", content: "Urban Zaiqa — Authentic Pakistani Restaurant & Catering" },
      {
        property: "og:description",
        content: "Premium Pakistani catering. Biryani, karahi, BBQ & desserts. Order on WhatsApp.",
      },
