...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — Urban Zaiqa Restaurant & Catering | 0332-3336821" },
      {
        name: "description",
        content:
          "Call 0332-3336821 or WhatsApp Urban Zaiqa for catering bookings, menu inquiries and custom dawat planning across Karachi.",
      },
      { property: "og:title", content: "Contact Urban Zaiqa" },
      { property: "og:description", content: "Call or WhatsApp us at 0332-3336821." },
    ],
  }),
