          ...
          <nav className="hidden lg:flex items-center gap-1">
            {links.map((l) => (
              <Link
                key={l.to}
                to={l.to}
                className="px-4 py-2 rounded-full text-sm font-medium text-cream/75 hover:text-saffron transition relative"
                ...
                {links.map((l, i) => (
                  ...
                  >
                    <Link
                      ...
                      className="block px-4 py-3 rounded-xl text-cream/85 hover:bg-saffron/10 hover:text-saffron transition font-medium"
                      activeProps={{ className: "text-saffron bg-saffron/10" }}
                      activeOptions={{ exact: true }}
                    >
                      {l.label}
                    </Link>
